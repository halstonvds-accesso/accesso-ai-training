...
2. **Claude Code** - You can use either:
   - **Claude Desktop (Great for beginners - after initial setup)**  with the **Code** tab selected (top-center of the app. Download here - https://code.claude.com/docs/en/desktop), OR
...
### Using Terminal (Claude Code CLI)
